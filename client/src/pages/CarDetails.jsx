        ...
        <div className='px-6 md:px-16 lg:px-24 xl:px-32 mt-16'>
            ...
            <div className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12'>
                ...
                <motion.div
                    ...
                    object-center rounded-xl mb-6 shadow-md' />
                    <motion.div
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                            ...
                            <ul className='grid grid-cols-1 sm:grid-cols-2 gap-2'>
                                {
                                    ["360 Camera", "Bluetooth", "GPS"
                                        , "Heated Seats", "Rear View Mirror"].map((item) => (
                                            <li key={item}>
                ...
                text-gray-500'>
                    ...
                    <div className='flex flex-col gap-2'>
                        ...
                        rounded-lg' required id='pick-date' min={new Date().toISOString().split('T')[0]} />
                    </div>
                    ...
                    py-3 font-medium text-white rounded-xl'>Book Now</button>

                    <p className='text-center text-sm'>No credit card required to register </p>
