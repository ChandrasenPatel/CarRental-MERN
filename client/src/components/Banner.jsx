...
const Banner = () => {
    return (
        ...
        px-8 min-md:pll-14 pt-10 bg-linear-to-r from-[#0558FF] to-[#A9CFFF]
        max-w-6xl mx-3 md:mx-auto rounded-2xl overflow-hidden'>

            <div className='texrt-white'>
                <h2 className='text-3xl font-medium'>Do You Own a Luxury Car?</h2>
                <p className='mt-2'>Monetize your vehicle effortlessly by listing it on CarDekho.</p>
                <p className='max-w-130'>We take care of insurance, driver verification and secure payments-so
                    you can earn passive income,stess-free.
                </p>
